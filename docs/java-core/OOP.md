...
Например, если у тебя есть класс "Птица", и у тебя есть еще один класс "Орел", то можно сказать, что "Орел IS-A Птица". То есть, класс "Орел" является подтипом (или наследником) класса "Птица".
...
Например, если у тебя есть класс "Автомобиль" и класс "Двигатель", то можно сказать, что "Автомобиль HAS-A Двигатель". Это означает, что объект класса "Автомобиль" содержит (или имеет) объект класса "Двигатель".
